  ...
  resolution:
  go test ./internal/exchange/polymarket/polymarket_test/... -run "TestClassifySource|TestDomainReliabilityScore" -v                                                                                                                          

  go test ./internal/exchange/polymarket/polymarket_test/... -run 'TestEnrichSourceLive|TestResolutionSourceFromMarket' -v
